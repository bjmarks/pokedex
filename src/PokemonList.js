      ...
      <div className={"pokedex " + (pokemon.types[0].type.name)}>
        <div className="top">
          ...
          <div className="image_placeholder">
            <img id="pokeImg" className="pokeImg" alt="pokemon" src={pokemon.sprites.other.home.front_default || pokemon.sprites.front_default || "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/0.png"} />
          </div>      
        </div>
        <div className="stat_container">
          <div className="types" id="types">
              {pokemon.types.map((t, i) => <div className={"type " + (t.type.name + "_dark")} key={i}>{t.type.name}</div>)}
          </div>
